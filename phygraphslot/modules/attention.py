...
from phygraphslot.lib.utils import init_param, init_fn
...
class SlotAttention(nn.Module):
    ...
    def forward(self, 
        ...
        for _ in range(self.num_iterations):
            ...
            # Recurrent update.
            slots = self.gru(updates.reshape(-1, D), slots.reshape(-1, D))
