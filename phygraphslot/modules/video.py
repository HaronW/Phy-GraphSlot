...
class phygraphslot(nn.Module):
    ...
    def forward(self, video: Array, conditioning: Optional[Array] = None,
                ...
                padding_mask: Optional[Array] = None,is_extract_slots: bool = False, **kwargs) -> ArrayTree:
        ...
        if continue_from_previous_state:
            ...
            init_slots = self.initializer(conditioning, batch_size=video.shape[0])
            init_slots = init_slots.to(video.device)
        ...
        if is_extract_slots: return corrected_slots
